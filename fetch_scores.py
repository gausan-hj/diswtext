    ...
    <style>
        * {
        ...
        @keyframes headerGlow {
            0% { box-shadow: 0 4px 16px rgba(234, 179, 8, 0.1); }
            50% { box-shadow: 0 4px 16px rgba(168, 85, 247, 0.1); }
            100% { box-shadow: 0 4px 16px rgba(59, 130, 246, 0.1); }
        }
        ...
        h1 {
            ...
            font-weight: 600;
            color: var(--text-primary);
            background: linear-gradient(135deg, var(--star-primary), var(--night-primary), var(--ocean-primary));
        ...
        .rank-card {
            ...
            position: relative;
            overflow: hidden;
            animation: cardFloatIn 0.6s ease backwards;
        }
        ...
        .rank-card[data-group="星穹组"] {
            ...
            background: linear-gradient(135deg, var(--star-bg), var(--card-bg));
        }
        .rank-card[data-group="夜曜组"] {
            border-left-color: var(--night-primary);
            background: linear-gradient(135deg, var(--night-bg), var(--card-bg));
        }
        .rank-card[data-group="沧澜组"] {
            border-left-color: var(--ocean-primary);
            background: linear-gradient(135deg, var(--ocean-bg), var(--card-bg));
        }
        ...
        .rank-card.rank-down {
            animation: rankDown 0.6s cubic-bezier(0.34, 1.56, 0.64, 1);
        }
        ...
        @keyframes rankDown {
            0%, 100% { transform: translateY(0); }
            30% { transform: translateY(8px) scale(0.97); }
            60% { transform: translateY(-2px); }
        }
        ...
        .group-card {
            ...
            position: relative;
            overflow: hidden;
            animation: groupSlideIn 0.8s ease backwards;
        }
        ...
        .group-emoji {
            font-size: 1.4rem;
            animation: emojiWiggle 3s infinite;
        }
        ...
        @keyframes rewardGlow {
            0% { box-shadow: 0 8px 24px rgba(234, 179, 8, 0.2); }
            50% { box-shadow: 0 8px 24px rgba(168, 85, 247, 0.2); }
            100% { box-shadow: 0 8px 24px rgba(59, 130, 246, 0.2); }
        }
        ...
        .reward-header h2 {
            ...
            font-weight: 700;
            color: var(--text-primary);
            background: linear-gradient(135deg, var(--star-primary), var(--night-primary));
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
        }
        ...
        .reward-item {
            ...
            border: 1px solid var(--border-subtle);
            transition: all 0.3s;
            animation: rewardItemFloat 0.8s ease backwards;
            position: relative;
            overflow: hidden;
        }
        ...
        .reward-condition {
            ...
            border: 1px solid var(--border-light);
            margin-bottom: 10px;
            animation: conditionPulse 2s infinite;
        }

        @keyframes conditionPulse {
            0%, 100% { border-color: var(--border-light); }
            50% { border-color: var(--star-primary); }
        }
        ...
        @keyframes notePulse {
            0%, 100% { border-color: var(--border-light); }
            50% { border-color: var(--night-primary); }
        }
        ...
        .footer {
            ...
            animation: footerFade 3s infinite;
        }
